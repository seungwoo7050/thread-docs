...
+	$(MAKE) check-data-model
 ...
 check-portable:
diff --git a/tests/portability/test_data_model.cpp b/tests/portability/test_data_model.cpp
new file mode 100644
index 0000000..ec6a988
--- /dev/null
+++ b/tests/portability/test_data_model.cpp
@@ -0,0 +1,29 @@
+#include <climits>
+#include <cstddef>
+#include <iostream>
