## `test(routing): reject invalid wallet credentials`
...
+    registry.add("gateway.downstream.wallet.api-key", () -> WALLET_KEY);
   ...
   @BeforeEach
diff --git a/src/test/java/com/sportsbook/gateway/routing/WalletDownstreamPropertiesTest.java b/src/test/java/com/sportsbook/gateway/routing/WalletDownstreamPropertiesTest.java
new file mode 100644
index 0000000..504e139
--- /dev/null
+++ b/src/test/java/com/sportsbook/gateway/routing/WalletDownstreamPropertiesTest.java
@@ -0,0 +1,83 @@
