## `test(domain): reject malformed draft fingerprints`

diff --git a/src/test/java/com/sportsbook/betting/domain/BetDraftTest.java b/src/test/java/com/sportsbook/betting/domain/BetDraftTest.java
new file mode 100644
index 0000000..673123b
--- /dev/null
+++ b/src/test/java/com/sportsbook/betting/domain/BetDraftTest.java
@@ -0,0 +1,31 @@
...
## `feat(database): create bet aggregate schema`

diff --git a/src/main/resources/db/migration/V1__bet_and_leg.sql b/src/main/resources/db/migration/V1__bet_and_leg.sql
new file mode 100644
index 0000000..55f80f6
--- /dev/null
+++ b/src/main/resources/db/migration/V1__bet_and_leg.sql
@@ -0,0 +1,76 @@
...
## `test(database): lock initial schema checksum`
