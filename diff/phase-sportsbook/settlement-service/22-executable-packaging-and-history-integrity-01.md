...
## `build(maven): scaffold Java 17 settlement service`

diff --git a/pom.xml b/pom.xml
new file mode 100644
index 0000000..8b10c70
--- /dev/null
+++ b/pom.xml
@@ -0,0 +1,56 @@
...
## `test(build): enforce Java and protocol baseline`
...
## `build(wrapper): add Maven 3.9.11 wrapper`
