# 재현 가능한 Java 17 빌드·성능 게이트와 1.0 릴리스

## `build(maven): initialize Java 17 service`

diff --git a/pom.xml b/pom.xml
new file mode 100644
index 0000000..91196c6
--- /dev/null
+++ b/pom.xml
@@ -0,0 +1,27 @@
...
+    <description>Sportsbook event and odds ingress service</description>
+
+    <properties>
...
## `build(wrapper): add Maven wrapper`
